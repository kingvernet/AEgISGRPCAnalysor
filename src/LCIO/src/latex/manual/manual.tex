...
%\title{LCIO [v2-12] -  Users manual}
\title{{\Huge\bf LCIO  -  Users manual} \\ v2-12}
...
%\begin{verbatim} 
%  export LCIO=/lcio/v2-12                <-- modify as appropriate
...
\begin{verbatim}
  ant doc 
\end{verbatim}
and then open the file \verb|/doc/api/index.html| with your Browser. %$
...
\begin{verbatim}
  ant doc.manual
\end{verbatim}
as \verb|/doc/manual.pdf| and \verb|/doc/manual.ps| provided you have latex in your 
\verb|$PATH| %$
